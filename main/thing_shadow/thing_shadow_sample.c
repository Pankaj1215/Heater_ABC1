...
//
////
//// #include "wifi_core.h"  // New added
////#include "thing_shadow_sample.h"
//
//
///*!
...
////
////
////  //  printf("before IOT UNUSED print\n ");
////
////    IOT_UNUSED(pThingName);
////    IOT_UNUSED(action);
////    IOT_UNUSED(pReceivedJsonDocument);
...
//
//    // Working..
////    scp.pMyThingName = "RaspberryPi";
////    scp.pMqttClientId = "myPiShadow";
////    scp.mqttClientIdLen = (uint16_t) strlen("myPiShadow");
//
//    // Testing   // P_ESP32/P_ESP_Shadow
////        scp.pMyThingName = "P_ESP32";
////        scp.pMqttClientId = "P_ESP_Shadow";
////        scp.mqttClientIdLen = (uint16_t) strlen("P_ESP_Shadow");
//
...
//
//
//                   // printf("after aws_iot_shadow_update\n ");
//                    // Working..
////                    rc = aws_iot_shadow_update(&mqttClient, "RaspberryPi", "{\"state\":{\"reported\":{\"welcome\":\"Hello World\"}}}",
////                                               ShadowUpdateStatusCallback, NULL, 4, true);
//
////                    rc = aws_iot_shadow_update(&mqttClient, "P_ESP32", "{\"state\":{\"reported\":{\"welcome\":\"ello23 \"}}}",
////                                               ShadowUpdateStatusCallback, NULL, 4, true);
//
//                  //  rc = aws_iot_shadow_update(&mqttClient, CONFIG_AWS_EXAMPLE_THING_NAME, "{\"state\":{\"reported\":{\"welcome\":\"A123\"}}}",
//                  //                             ShadowUpdateStatusCallback, NULL, 4, true);
//
...
//
//
//// because this exists in the main firmare..
////static void initialise_wifi(void)
////{
////    tcpip_adapter_init();
////    wifi_event_group = xEventGroupCreate();
...
//
//
//// commented for as it exists in the main firmware...
////void app_main()
////{
...
////    xTaskCreate(&aws_iot_task, "aws_iot_task", 8192, NULL, 5, NULL);      // Testing
////}
//
//
